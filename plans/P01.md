...
| New issues discovered after 2026-07-31 | Triage | Classify all new open issues; fix any critical/high correctness, availability, migration, security, or compatibility defect in this maintenance effort | S00/S13 | `docs/maintenance/RUNTIME_AUDIT.md` | `OWNER_TO_COMMIT` | REVIEWED | The canonical fork had no reports or pull requests in the anonymous GitHub API inventory on 2026-08-01; the previously inventoried maintenance descriptions remain unchanged, and recent closed descriptions exposed no unresolved critical/high regression. |
...
| S13 | Evidence-based critical runtime correctness audit and fixes | S12 | DONE | 2026-08-01T04:57:49Z | 2026-08-01T05:26:49Z | `OWNER_TO_COMMIT` | `docs/P01/S13.md`; suggested commit: `S13: harden FMI runtime failure boundaries` |
| S14 | Home Assistant compatibility, dependency, security, and privacy audit | S13 | NOT_STARTED | — | — | — | `docs/P01/S14.md` |
